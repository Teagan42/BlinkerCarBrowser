        ...
        ViewInteraction textView = onView(
                  allOf(withText("Audi"),
                        childAtPosition(
                                  ...
                                  0),
                        isDisplayed()));
        textView.check(matches(withText("Audi")));
        ...
        ViewInteraction textView2 = onView(
                  allOf(withText("BMW"),
                        childAtPosition(
                                  ...
                                  0),
                        isDisplayed()));
        textView2.check(matches(withText("BMW")));
